...
final class LiteCell: BaseCVCell {
    ...
    weak var delegate: VcCardCVCellDelegate?
    ...
    func setupCell(product: Product) {
        ...
        DispatchQueue.main.async {
            self.favoriteButton.setImage(UIImage(systemName: product.isSelected ? "heart.fill" : "heart")?.withConfiguration(UIImage.SymbolConfiguration(pointSize: self.layoutSetup.iconSizeCard)), for: .normal
            )
        }
